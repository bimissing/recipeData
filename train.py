...
def save_checkpoint(state, is_best, filename='vggall3checkpoint.pth.tar'):
    torch.save(state, filename + '_vggall3latest.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_vggall3latest.pth.tar', filename + '_vggall3best.pth.tar')
